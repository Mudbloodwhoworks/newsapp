...
function News(props) {
  ...
  let resultNews = async () => {
    const url = `https://newsapi.org/v2/top-headlines?country=in&category=${category}&page=${page}&apiKey=fb4b4d48cc3549218df21116d46852de`;
  ...
  let fetchData = async () => {
    const url = `https://newsapi.org/v2/top-headlines?country=in&category=${category}&page=${
      page + 1
    }&apiKey=fb4b4d48cc3549218df21116d46852de`;
    setPage(page + 1);
      ...
      <InfiniteScroll
        ...
        endMessage={
          <p style={{ textAlign: "center" }}>
            <b>Yay! You have seen it all ©PRIYANKA MAAM</b>
          </p>
        }
      >
